      ...
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <noscript>
          <p class="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg mt-8">
            ...
            <a target="_blank" class="text-primary underline" href="https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/c932b21f0ee4f43cae0cd8f5adab8fc4/document/render/html?language=de">Link</a>,
...
// SEO Meta Tags
useSeoMeta({
  title: 'Datenschutzerklärung - Fix & Frei Umzüge und Entrümpelung',
  description: 'Datenschutzerklärung von Fix & Frei Umzüge und Entrümpelung - Informationen zum Schutz Ihrer persönlichen Daten.',
  ogTitle: 'Datenschutzerklärung - Fix & Frei Umzüge und Entrümpelung',
  ogDescription: 'Datenschutzerklärung von Fix & Frei Umzüge und Entrümpelung - Informationen zum Schutz Ihrer persönlichen Daten.',
  ogImage: 'https://fix-und-frei.de/favicon.png',
  ogUrl: 'https://fix-und-frei.de/datenschutz',
...
useHead({
  ...
  link: [
    {
      rel: 'canonical',
      href: 'https://fix-und-frei.de/datenschutz'
    }
  ]
})
...
onMounted(() => {
  fetch('https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/c932b21f0ee4f43cae0cd8f5adab8fc4/document/render/html?language=de')
